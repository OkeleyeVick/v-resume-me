				...
				<div className="flex flex-col md:col-start-2 md:col-end-10 lg:col-start-3 lg:col-end-9 md:grid md:grid-cols-10">
					...
					<div className="md:col-start-1 md:col-end-11 mt-4 flex flex-col px-1">
						...
						<div className="mt-10">
							<Link
								to="/create-resume"
								className="text-sm md:text-base text-white bg-main rounded-md py-4 px-6 md:py-5 transition ease-in-out duration-500 hover:bg-hoverBgClr selection:text-white font-semibold">
